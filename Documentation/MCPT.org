...
1. Increase the "NUM_OF_PRIMS" variable in [[../utils.h::14]] file
2. Add the new primitive as enumerated type in [[../utils.c::16]] file
3. Make sure that the enumerated type is the same with the char table "prim_names" in file [[../utils.c::5]]
4. Write the wrapper code in [[../commprof.c]] - use the other functions as a template
...
** TODO Add timing for primitives
