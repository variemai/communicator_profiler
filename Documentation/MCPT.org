...
2. Add the new primitive as enumerated type in [[../utils.h::27]] file
3. Make sure that the enumerated type is the same with the char table "prim_names" in file [[../commprof.c::23]]
...
** TODO Add Recv and Irecv operations
