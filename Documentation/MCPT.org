...
** DONE Supported MPI Collective communication Primitives
- MPI_Barrier
- MPI_Ibarrier
- MPI_Gatherv
- MPI_Scatter
...
1. Increase the "NUM_OF_PRIMS" variable in [[../utils.c][utils.c]] file
2. Add the new primitive as enumerated type in [[../utils.c][utils.c]] file
3. Make sure that the enumerated type is the same with the char table "prim_names" in file [[/home/vardas/repos/communicator_profiler/utils.c]]
4. Write the wrapper code in  [[/home/vardas/repos/communicator_profiler/commprof.c]] - use the other functions as a template
